...
public class NetworkConfiguration {
    ...
    public String getCommandChannelHost() throws SocketException, UnknownHostException {
        return env.getEnv("CRYOSTAT_LISTEN_HOST", getWebServerHost());
    }
    ...
    public int getInternalCommandChannelPort() {
        return Integer.parseInt(
                env.getEnv("CRYOSTAT_LISTEN_PORT", String.valueOf(getDefaultCommandChannelPort())));
    }
