...
public class ReportJwtDownloadIT extends JwtAssetsSelfTest {

    static final String TEST_RECORDING_NAME = "ReportJwtDownloadIT";
        ...
        try {
            ...
            String downloadUrl =
                    getTokenDownloadUrl(
                            new URL(
                                    String.format(
                                            "http://%s:%d/api/beta/targets/%s/reports/%s",
                                            Utils.WEB_HOST,
                                            Utils.WEB_PORT,
