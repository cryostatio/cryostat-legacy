...
class TargetTemplateGetHandlerTest {
    ...
    @BeforeEach
    void setup() {
        this.handler = new TargetTemplateGetHandler(auth, jwt, () -> webServer,
                targetConnectionManager, logger);
    }
    ...
    class ApiSpec {
        ...
        void shouldUseExpectedPath() {
            MatcherAssert.assertThat(handler.path(), Matchers.equalTo("/api/beta/targets/:targetId/templates/:templateName/type/:templateType"));
        }

        @Test
        void shouldRequireResourceActions() {
            MatcherAssert.assertThat(handler.resourceActions(), Matchers.equalTo(EnumSet.of(ResourceAction.READ_TARGET, ResourceAction.READ_TEMPLATE)));
        }
    ...
    class Behaviour {
        ...
        void shouldRespond404IfNotFound() throws Exception{
            ...
            Mockito.when(templateService.getXml(Mockito.anyString(),
        ...
        void shouldSendFileIfFound() throws Exception{
            ...
            Mockito.when(templateService.getXml(Mockito.anyString(),
                        Mockito.any())).thenReturn(Optional.of(doc));
