...
class NetworkConfigurationTest {
    ...
    void shouldReportWebServerHost() throws SocketException, UnknownHostException {
        ...
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_WEB_HOST"), Mockito.anyString())).thenReturn("bar");
    ...
    void shouldReportCommandChannelHost() throws SocketException, UnknownHostException {
        Mockito.when(resolver.getHostAddress()).thenReturn("foo");
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_WEB_HOST"), Mockito.anyString())).thenReturn("bar");
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_LISTEN_HOST"), Mockito.anyString())).thenReturn("baz");
    ...
    void shouldReportInternalWebServerPort() {
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_WEB_PORT"), Mockito.anyString())).thenReturn("1234");
    ...
    void shouldReportExternalWebServerPort() {
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_WEB_PORT"), Mockito.anyString())).thenReturn("8282");
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_EXT_WEB_PORT"), Mockito.anyString())).thenReturn("1234");
    ...
    void shouldReportInternalCommandChannelPort() {
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_LISTEN_PORT"), Mockito.anyString())).thenReturn("9191");
    ...
    void shouldReportExternalCommandChannelPort() {
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_EXT_LISTEN_PORT"), Mockito.anyString())).thenReturn("9292");
        Mockito.when(env.getEnv(Mockito.eq("CONTAINER_JFR_LISTEN_PORT"), Mockito.anyString())).thenReturn("9191");
